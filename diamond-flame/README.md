...
2. This folder published on GitHub Pages.
...
branch** → select your branch and `/ (root)`. The Diamond Flame site lives in
the `diamond-flame/` subfolder, so its URL is
`https://<your-user>.github.io/<repo>/diamond-flame/`.
